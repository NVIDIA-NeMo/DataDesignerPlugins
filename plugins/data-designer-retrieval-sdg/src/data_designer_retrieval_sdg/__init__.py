...
The package registers three ``data_designer.plugins`` entry points:
...
- ``qa-evaluation-normalizer``: post-batch processor that stabilizes
  overall score types before Parquet checkpointing.
